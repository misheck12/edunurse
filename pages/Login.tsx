  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#f6f7f8]">
      <div className="flex w-full max-w-6xl flex-col overflow-hidden rounded-xl bg-white shadow-xl md:min-h-[650px] md:flex-row">
          ...
          <div className="relative z-10 p-12 h-full flex flex-col justify-between text-white">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold">
                EduNurse<span className="font-light opacity-80">Pro</span>
              </span>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-white/90 font-light">
                Access curriculum-aligned teaching documents, generate lesson plans,
                ...
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((index) => (
                    <img
                      ...
                      src={`https://picsum.photos/id/${index + 50}/100/100`}
                      alt=""
                    />
                  ))}
                </div>
        ...
        <div className="flex w-full flex-col justify-center bg-white p-6 sm:p-8 md:w-1/2 md:p-16">
          <div className="w-full max-w-md mx-auto space-y-8">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold text-slate-900">Welcome back</h1>
              <p className="text-slate-500">
                Please enter your details to access your curriculum tools.
              </p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all"
              >

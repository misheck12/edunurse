  ...
  return (
    <div className="relative mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <SEO
        ...
        description="Browse and manage lesson plan templates for nursing and midwifery education. Customize built-in or create your own."
        canonicalPath="/templates"
        keywords="lesson plan templates, nursing education templates, OSCE template"
      />
      <div className="mb-8">
